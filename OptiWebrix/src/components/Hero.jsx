...
export default function Hero() {
  return (
    <div className="relative isolate overflow-hidden bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20 lg:py-24 lg:flex lg:items-center lg:gap-x-10 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg lg:flex-shrink-0">
          <motion.h1
            className="mt-6 sm:mt-10 text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tight text-foreground"
...
dark:drop-shadow-[0_0_20px_rgba(255,212,21,0.4)] dark:filter brightness-125">
          ...
          >
            <a
              href="https://api.whatsapp.com/send?phone=+919381309583&text=Hello%20Web%20Cros%20Team!%20I'm%20interested%20in%20learning%20more%20about%20your%20services."
              target="_blank"
        ...
        <motion.div
          className="mx-auto mt-8 sm:mt-12 lg:mt-0 flex justify-center"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.6 }}
        >
          <div className="relative w-full max-w-[280px] sm:max-w-[350px] lg:max-w-[500px]">
            <LottieAnimation 
