...
const timelineEvents = [
  {
    ...
    details:
      "OptiWebrix was born from a deep passion for minimal design and floral artistry, blending elegance and creativity to craft visually stunning digital experiences inspired by nature’s grace.",
  },
  {
    year: 2023,
