...
export function SparklesPreview() {
  return (
    <div className="h-fit w-full bg-background dark:bg-slate-950 flex flex-col items-center justify-center overflow-hidden">
      <h1 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center text-foreground dark:text-white relative z-20">
        OptiWebrix
      </h1>
      <div className="w-[40rem] h-40 relative">
        {/* Gradients - Updated to use amber colors to match your brand */}
        ...
        <div className="absolute inset-0 w-full h-full bg-background dark:bg-slate-950 [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
}